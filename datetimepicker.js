function datetimepicker(element){
	...
	self.setStyles = function(){
		...
		let calStyle = 'input[type=number]{-moz-appearance:textfield!important}input::-webkit-inner-spin-button,input::-webkit-outer-spin-button{-webkit-appearance:none!important}#calWrap{width:260px;border:1px solid #bbb}#calWrapper{position:relative}#calContainer{position:relative;width:inherit;height:inherit}#calHeader{display:-webkit-box;display:-ms-flexbox;display:flex;width:100%;-ms-flex-pack:distribute;justify-content:space-around;-webkit-box-align:center;-ms-flex-align:center;align-items:center;height:100%;border-bottom:1px solid #bbb}#calDaysHeader{margin:0;padding:10px 0;font-size:13px;font-weight:700;border-bottom:1px solid #bbb}#calDaysBody{margin:0;padding:5px 0;border-bottom:1px solid #bbb}.calDateNow{font-size:15px;background:#ccc;font-weight:700}#calDays{display:inline-block;width:14.28%;text-align:center;font-size:15px;cursor:pointer}#calDays:hover{font-size:15px;background:#ddd;font-weight:700}#timeContainer{width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;text-align:center;font-weight:700;font-size:15px}#timeText{padding:5px 5px}#calHeaderOption{font-weight:700;padding:15px;display:-webkit-box;display:-ms-flexbox;display:flex}.headText{padding:0 10px;font-weight:700}#calHeaderText{display:inline-block;width:14.28%;color:#666;font-weight:700;text-align:center}#calClose{position:absolute;display:block;right:0;margin-top:-20px;margin-right:-8px;border-radius:50%;cursor:pointer;background:#ddd;padding:0 3px;font-size:12px}.calPointer{cursor:pointer!important}.timeInput{width:20px;border:1px solid #bbb;text-align:center;font-weight:700}.calArrow{padding:0 5px;cursor:pointer}.calArrow:hover{background:#d9d4d1;font-weight:bolder}.from_prev_month{color:#696969;}.from_next_month{color:#696969;}';
